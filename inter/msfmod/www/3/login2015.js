                ...
                if (result) {
                    ...
                    if (obj.success || obj.transfer) {
                        ...
                        try{
                        	...
                        	var regExp = /[\w-]+\.(jd\.hk|jd360\.hk)\//;
                        	var match = docRef.match(regExp);
                        	if(match != null && match.length>=2){
                        		relayUrl = "http://sso." +match[1]+ "/relay/loginRelay.htm";                        		
                        	}                        	
                        }catch(e){
                        }        
                    ...
                    if (obj.venture) {
                        ...
                        window.parent.location = "http://safe.jd.com/dangerousVerify/index.action?username=" + obj.venture + "&ReturnUrl=" + encodeURI(parentRef) + "&t=" + new Date().getTime();
                        return;
                    }
                    if (obj.resetpwd) {
